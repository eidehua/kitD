...
net.layers{end+1} = struct('type', 'conv', ...
                           'weights', {{1e-4*randn(40,40,3,64, 'single'), zeros(1, 64, 'single')}}, ...
                           'learningRate',[1,2],...
                           'dilate', 1, ...
                           'stride', 1, ...
                           'pad', 2,...
...
% 4 conv2
net.layers{end+1} = struct('type', 'conv', ...
                           'weights', {{0.001*randn(20,20,64,64, 'single'), zeros(1, 64, 'single')}}, ...
                           'learningRate',[1,2],...
                           'dilate', 1, ...
                           'stride', 1, ...
                           'pad', 0,...
...
% % 7 conv5
% net.layers{end+1} = struct('type', 'conv', ...
%                            'weights', {{0.01*randn(30,30,64,64, 'single'), zeros(1, 64, 'single')}}, ...
%                            'learningRate',[1,2],...
%                            'dilate', 1, ...
%                            'stride', 1, ...
%                            'pad', 0,...
...
% % 10 conv5
% net.layers{end+1} = struct('type', 'conv', ...
%                            'weights', {{0.05*randn(50,50,64,100, 'single'), zeros(1, 100, 'single')}}, ...
%                            'learningRate',[1,2],...
%                            'dilate', 1, ...
%                            'stride', 1, ...
%                            'pad', 0,...
