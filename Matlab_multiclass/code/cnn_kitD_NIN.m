...
net.layers{end+1} = struct('type', 'conv', ...
                           'name', 'conv1', ...
                           'weights', {init_weights(5,3,192)}, ... %196
                           'learningRate', lr, ...
                           'dilate', 1, ...
                           'stride', 1, ...
                           'pad', 2, ...
...
net.layers{end+1} = struct('type', 'conv', ...
                           'name', 'cccp1', ...
                           'weights', {init_weights(1,192,160)}, ...    %196, 160
                           'dilate', 1, ...
                           'learningRate', lr, ...
                           'stride', 1, ...
                           'pad', 0, ...
...
net.layers{end+1} = struct('type', 'conv', ...
                           'name', 'cccp2', ...
                           'weights', {init_weights(1,160,96)}, ...    %160, 96
                           'learningRate', lr, ...
                           'dilate', 1, ...
                           'stride', 1, ...
                           'pad', 0, ...
...
net.layers{end+1} = struct('type', 'conv', ...
                           'name', 'conv2', ...
                           'weights', {init_weights(5,96,192)}, ... % 96,192
                           'learningRate', lr, ...
                           'dilate', 1, ...
                           'stride', 1, ...
                           'pad', 2, ...
...
net.layers{end+1} = struct('type', 'conv', ...
                           'name', 'cccp4', ...
                           'weights', {init_weights(1,192,192)}, ...    % 192, 192
                           'learningRate', lr, ...
                           'dilate', 1, ...
                           'stride', 1, ...
                           'pad', 0, ...
...
net.layers{end+1} = struct('type', 'conv', ...          %% I added this!!
                           'name', 'cccped1', ...
                           'weights', {init_weights(1,192,192)}, ...
                           'learningRate', lr, ...
                           'dilate', 1, ...
                           ...
                           'pad', 0, ...
                           'opts',{{}}) ;
net.layers{end+1} = struct('type', 'relu', 'name', 'relu_cccped1', 'leak', 0) ; %% I added this!
...
net.layers{end+1} = struct('type', 'conv', ...
                           'name', 'conv2', ...
                           'weights', {init_weights(5,192,192)}, ... % 96,192
                           'learningRate', lr, ...
                           'dilate', 1, ...
                           'stride', 1, ...
                           'pad', 2, ...
...
net.layers{end+1} = struct('type', 'conv', ...
                           ...
                           'pad', 1, ...
                           'opts',{{}}) ;
net.layers{end+1} = struct('type', 'relu', 'name', 'relu3', 'leak', 0) ;
net.layers{end+1} = struct('type', 'conv', ...
                           'name', 'cccp5', ...
                           'weights', {init_weights(1,192,192)}, ...
                           'learningRate', lr, ...
